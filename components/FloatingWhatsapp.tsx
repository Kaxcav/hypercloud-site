...
export function FloatingWhatsapp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2.5 rounded-full border border-emerald-500/40 bg-emerald-600 px-4 py-3 text-white shadow-[0_8px_30px_rgb(5,150,105,0.4)] transition hover:scale-105 hover:bg-emerald-500 sm:bottom-8 sm:right-8"
    >
