...
const sectors = [
  {
    ...
    description:
      'Infraestrutura, produtividade e segurança em escala corporativa.'
  },
  {
    icon: Landmark,
    title: 'Governo',
    description:
      'Aquisições via ATAs, modernização e transformação digital do setor público.'
  },
  {
    icon: GraduationCap,
    title: 'Educação',
    description:
      'Google for Education, Chromebooks e plataformas para gestão acadêmica.'
  },
  {
    icon: HeartPulse,
    title: 'Saúde',
    description:
      'Soluções para hospitais e clínicas, com foco em LGPD e dados sensíveis.'
  }
];
  ...
  return (
    <>
      <InternalHero
        ...
        description="A Hypercloud é uma consultoria brasileira especializada em projetos de Tecnologia da Informação para empresas privadas, governo e instituições de ensino e saúde. Atuamos como Premier Partner do Google e operamos com independência sobre todas as principais plataformas de nuvem do mercado."
        primaryCta={{
        ...
        visual={
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-premium sm:p-7">
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-brand-200 bg-brand-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-brand-700">
            ...
            <p className="mt-3 text-[13px] leading-relaxed text-slate-600">
              Nascemos da convicção de que decisões de TI estratégica não
              deveriam estar presas a um único fornecedor. Por mais de uma
              década, nossos sócios construíram relacionamentos com os
              principais fabricantes de tecnologia do mundo.
            </p>

            <p className="mt-3 text-[13px] leading-relaxed text-slate-600">
              Hoje, somos uma operação independente focada em entregar projetos
              que vão da infraestrutura de Data Center ao software de gestão,
              com a liberdade de recomendar exatamente a tecnologia que cada
              cliente precisa.
            </p>

            <div className="mt-5 flex items-center gap-3 rounded-xl border border-slate-200/70 bg-slate-50/60 px-3.5 py-3">
              <ScrollText className="h-4 w-4 shrink-0 text-brand-600" />
        ...
        <div className="container-shell">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {pillars.map((pillar) => (
              <div
                key={pillar.title}
                className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:border-slate-300"
              >
      ...
      <section className="border-b border-slate-200/70 bg-slate-50 py-20 sm:py-24">
        <div className="container-shell">
          <div className="grid items-start gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-brand-200/80 bg-white/90 px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-brand-700 shadow-sm">
                <span className="h-1 w-1 rounded-full bg-brand-500" />
                Nosso compromisso
              </span>
              <h2 className="mt-5 text-balance text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl lg:text-[44px] lg:leading-[1.1]">
              ...
              <p className="mt-5 text-base leading-relaxed text-slate-600 sm:text-lg sm:leading-8">
                A Hypercloud opera sob um Programa de Integridade formal, com
                Código de Ética, Canal de Denúncias e políticas de conformidade
                publicadas. Para nós, transparência é parte do contrato.
              </p>
              <Link
                href="/setor-publico"
                className="mt-6 inline-flex items-center gap-2 rounded-md bg-brand-gradient px-5 py-3 text-[13px] font-semibold text-white shadow-brand transition hover:opacity-95"
              >
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
              ...
              <ul className="mt-5 space-y-3 text-[14px] text-slate-700">
                {[
      ...
      <SpecialistCta
        ...
        description="Escolha o canal mais confortável. Nossa equipe responde em até um dia útil com um especialista preparado para o seu cenário."
      />
    </>
  );
}
