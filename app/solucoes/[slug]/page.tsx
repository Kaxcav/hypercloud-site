    ...
    <>
      <section className="border-b border-slate-200/60 bg-gradient-to-b from-white to-slate-50 py-20 sm:py-24 lg:py-28">
        <div className="container-shell max-w-5xl">
          ...
          <h1 className="mt-6 text-balance text-4xl font-extrabold tracking-tighter text-slate-900 sm:text-5xl lg:text-6xl">{solution.title}</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">{solution.description}</p>
        ...
        <div className="container-shell max-w-5xl">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {solution.bullets.map((item) => (
              <div key={item} className="rounded-3xl border border-slate-200/60 bg-white p-6">
